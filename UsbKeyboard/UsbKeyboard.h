...
#ifndef __VUSB_IDLERATE__
#define __VUSB_IDLERATE__
...
class UsbKeyboardDevice {
 public:
  ...
  void sendMultiKeyStroke(byte modifiers, byte keyStroke1, byte keyStroke2, byte keyStroke3, byte keyStroke4, byte keyStroke5, byte keyStroke6 ) {
    ...
    reportBuffer[0] = modifiers;
    reportBuffer[1] = keyStroke1;
    reportBuffer[2] = keyStroke2;
    reportBuffer[3] = keyStroke3;
    reportBuffer[4] = keyStroke4;
    reportBuffer[5] = keyStroke5;
    reportBuffer[6] = keyStroke6;
    ...
    void sendMultiKeyStrokePR(byte modifiers, byte keyStroke1, byte keyStroke2, byte keyStroke3, byte keyStroke4, byte keyStroke5, byte keyStroke6 ) {
